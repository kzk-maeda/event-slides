...
<div class="self-intro-left">
  <p class="self-intro-label">ABOUT ME</p>
  <img src="./images/profile.jpg" alt="Kazuki Maeda" class="self-intro-avatar" />
  <p class="self-intro-name-left">Kazuki Maeda</p>
</div>
<div class="self-intro-right">
  <h2>自己紹介</h2>
  <ul>
  ...
  <div class="self-intro-sns">
    <img src="./images/qr_x.png" alt="X QR" class="self-intro-qr" />
    <p class="self-intro-x"><svg class="self-intro-x-logo" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg> @kzk_maeda</p>
  </div>
</div>
...
![2025年の読書記録 - 年間102冊読了](./images/booklog.png){.booklog-image}
...
![ポコポケ](./images/pokopoke.png){.booklog-image}
...
![ライト、ついてますか](./images/calligraphy.jpg)
